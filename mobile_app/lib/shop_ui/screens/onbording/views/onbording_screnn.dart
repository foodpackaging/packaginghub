...
import 'package:b2b_store/shop_ui/components/dot_indicators.dart';
...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    Onbord(
      image: "assets/Illustration/Illustration_lightTheme_0.png",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_0.png",
      name: "Find the item you’ve \nbeen looking for",
      description:
          "Here you’ll see rich varieties of goods, carefully classified for seamless browsing experience.",
    ),
    Onbord(
      image: "assets/Illustration/Illustration_lightTheme_1.png",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_1.png",
      name: "Get those shopping \nbags filled",
      description:
          "Add any item you want to your cart, or save it on your wishlist, so you don’t miss it in your future purchases.",
    ),
    Onbord(
      image: "assets/Illustration/Illustration_lightTheme_2.png",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_2.png",
      name: "Fast & secure \npayment",
      description: "There are many payment options available for your ease.",
    ),
    Onbord(
      image: "assets/Illustration/Illustration_lightTheme_3.png",
    ...
    Onbord(
      image: "assets/Illustration/Illustration_lightTheme_4.png",
