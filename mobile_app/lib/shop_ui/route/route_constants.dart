...
const String onboardingFormScreenRoute = "onboardingForm";
const String verificationScreenRoute = "verification";
const String onboardingAddressScreenRoute = "onboardingAddress";
const String mapLocationPickerScreenRoute = "mapLocationPicker";
const String addressDetailsScreenRoute = "addressDetails";

// New Routes
// Password reset is two steps: verify the emailed code, then set a new password
// (the second step reuses newPasswordScreenRoute, declared above).
const String verifyResetCodeScreenRoute = "verify_reset_code";
const String emailConfirmationSuccessScreenRoute = "email_confirmation_success";
const String myReturnsScreenRoute = "my_returns";
const String returnDetailsScreenRoute = "return_details";
